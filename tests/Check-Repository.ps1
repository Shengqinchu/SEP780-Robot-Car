...
Assert-Condition ($mobileProtocol -match 'MAX_PWM\s*=\s*200') 'Android maximum remote PWM must match firmware.'
...
Assert-Condition ($robotConfig -match 'max_pwm\s*=\s*200') 'Firmware maximum PWM must match Android.'
